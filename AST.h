...
public:
    ...
    virtual llvm::Value* codegen(Codegen_visitor* v) = 0;
};
...
public:
    ...
    Value* codegen(Codegen_visitor* v) override;
};
...
public:
    ...
    virtual void codegen(Codegen_visitor*) = 0;
};
...
public:
    ...
    void accept(Visitor* v) override;
    void codegen(Codegen_visitor*) override;
};
